...
class RecaudacionesMovistarExcel extends CargaModelo_Actualizaciones_Abstract implements CargaModelo_Actualizaciones_Interface, Iterator{
	...
	function processRecord(&$line) {
		...
		if (floatval($line['pagos'][1])==0 && floatval($line['ajustes'][1])==0) return null;
		if ($line['pagos'][1]=='' && $line['ajustes'][1]=='') return null;
		...
		$procesar=false;
		if ($line['pagos'][1]!='' && floatval($line['pagos'][1])>_ZERO_THRESHOLD) {
