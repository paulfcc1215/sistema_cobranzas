...
class CarteraMovistarExcel extends CargaModelo_Uploadable_Abstract implements CargaModelo_Uploadable_Interface, Iterator{
	...
	function processRecord(&$line) {
		...
		if (trim($line['venc_gestion'][1])=='' or !in_array(trim($line['venc_gestion'][1]),array('0','30','60','90')))
			throw new Exception('Venc_Gestion inválido debe ser (0,30,60 ó 90) en línea '.$this->ptr.' ('.$line['venc_gestion'][1].')');
