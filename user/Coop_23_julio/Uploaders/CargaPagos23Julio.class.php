<?php
	...
	class Cargador_CargaPagos23Julio extends CargaModelo_Actualizaciones_Abstract implements CargaModelo_Actualizaciones_Interface, Iterator{
	...
	class CargaPagos23Julio extends CargaModelo_Handler_Abstract {
		...
		function execute($step, &$__data) {
			...
			switch($step) {
				case '3':
					$uploader = new Cargador_CargaPagos23Julio(_TMP_UPLOAD_FOLDER.'/'.$SM->carga_process['source_file']);
					return $uploader;
				break;
