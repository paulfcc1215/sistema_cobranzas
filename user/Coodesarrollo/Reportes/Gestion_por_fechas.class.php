<?php
class Gestion_por_fechas implements Reporte_Interface {
	private $cache=array();
	...
	public function execute($_post,$_get,&$result,&$additional_data=array(),&$_T=array()) {
		//if($_SERVER['REMOTE_ADDR']!='172.16.30.6') die('Reporte en construcción');
		$db = DB::getInstance();
		...
		switch ($_get['step']) {
			...
			default:
				...
				$_T['maintitle']='INTERAGUA - Reporte de gestion por fechas';
				$_T['maincontent']='
				<script>
