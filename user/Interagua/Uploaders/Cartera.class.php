		...
		switch($line['tipo identificacion'][1]) {
			...
			default:
				if($line['tipo_identificacion']!='')
					throw new Exception('No se conoce el tipo de identificacion "'.$line['tipo identificacion'][1].'" (Solo se permiten {CÉDULA DE CIUDADANIA, CONSUMIDOR FINAL, PASAPORTE, RUC}');
