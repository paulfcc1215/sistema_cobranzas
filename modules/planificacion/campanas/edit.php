...
switch($_GET['step']) {
    ...
    default:
        ...
        $_T['maintitle']='Planificación de Operación - campanas - Editar Campaña';
        if($error!='') {
  ...
  <button class="btn btn-warning" type="button" onclick="window.location=\'?mod=planificacion/procesos/index&id_camp='.$_GET['id'].'\'">Ver Procesos</button> 
        </form>
        <script>
        ';
