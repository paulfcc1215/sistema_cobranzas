...
switch($_GET['step']) {
  ...
  <button class="btn btn-warning" type="button" onclick="window.location=\'?'.Helpers::arr_to_url($_GET,array(),array('mod'=>'planificacion/udns/del','id'=>$udn->id_udn)).'\'">Eliminar UDN Completa</button>
  <br><br>
