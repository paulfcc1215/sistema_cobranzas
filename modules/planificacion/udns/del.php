...
switch($_GET['step']) {
    ...
    default:
        ...
        <button class="btn btn-primary" type="button" onclick="window.location=\'?'.Helpers::arr_to_url($_GET,array(),array('mod'=>'planificacion/udns/edit','id'=>$udn->id_udn)).'\'">Cancelar</button>
        </form>
        ';
    break;
}