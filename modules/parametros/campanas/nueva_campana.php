<?php
	...
	if(!Auth::hasPrivileges('AUTH_PARAMETROS_CAMPANAS_CREAR')) throw new Exception('No autorizado - AUTH_PARAMETROS_CAMPANAS_CREAR');
	...
	$_T['maintitle']='Parámetros del sistema - Campañas - Crear campaña';
