<?php
    if(!Auth::hasPrivileges('AUTH_PARAMETROS_UDNS_CREAR')) throw new Exception('No autorizado - AUTH_PARAMETROS_UDNS_CREAR');
    ...
    $_T['maintitle']='Parámetros del sistema - UDNs - Nueva UDN';

    switch($_GET['step']) {
        case '2':
            try {
                if($_POST['id_empresa']=='') throw new Exception('Empresa inválida');
                if($_POST['udn']=='') throw new Exception('Debe indicar el nombre de la UDN');
